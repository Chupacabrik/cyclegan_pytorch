...
dir_human_train = '../photo/train'  #'/../photo/train'
dir_human_test =  '../photo/test' #'/../photo/test'
dir_simpsons_train = '../style/train'  #'/../style/train'
dir_simpsons_test = '../style/test/'  #'/../style/test/'
batch_size = 1
