...
# training 
    ...
    torch.save(G_A.state_dict(), "..working/saved_models/G_AB_%d.pth" % (epoch + 1))
    torch.save(G_B.state_dict(), "..working/saved_models/G_BA_%d.pth" % (epoch + 1))
    torch.save(D_A.state_dict(), "..working/saved_models/D_A_%d.pth" % (epoch + 1))
    torch.save(D_B.state_dict(), "..working/saved_models/D_B_%d.pth" % (epoch + 1))
